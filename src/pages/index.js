...
const IndexPage = () => (
  <div style={{color: '#222' }} id="me" typeof="foaf:Person">
    ...
    <section style={{ color: '#666' }}>
      ...
      <p>I'm perhaps most known for my voice on <a href="https://hachyderm.io/@thisismissem" rel="me" title="Follow Emelia on Mastodon">Mastodon</a>, where I talk about Tech, Politics, Distributed Web, Social Media Moderation, rights for sex workers and equality. You can find my writing on <a href="https://medium.com/@thisismissem" rel="me" title="Read articles by Emelia on Medium">Medium</a>, when I publish it.</p>
